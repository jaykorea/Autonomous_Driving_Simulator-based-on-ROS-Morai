...
(cl:defclass <RadarTracks> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tracks
    :reader tracks
    :initarg :tracks
    :type (cl:vector morai_msgs-msg:RadarTrack)
   :initform (cl:make-array 0 :element-type 'morai_msgs-msg:RadarTrack :initial-element (cl:make-instance 'morai_msgs-msg:RadarTrack))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RadarTracks>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadarTracks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morai_msgs-msg:<RadarTracks> is deprecated: use morai_msgs-msg:RadarTracks instead.")))
...
(cl:defmethod tracks-val ((m <RadarTracks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:tracks-val is deprecated.  Use morai_msgs-msg:tracks instead.")
  (tracks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RadarTracks>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tracks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'morai_msgs-msg:RadarTrack))
