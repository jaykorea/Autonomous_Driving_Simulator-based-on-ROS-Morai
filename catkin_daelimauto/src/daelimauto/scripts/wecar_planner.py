...
from std_msgs.msg import Float64,Int32,Int16,Float32MultiArray,Int8
...
class wecar_planner():
    def __init__(self):
        ...
        rospy.Subscriber("/darknet_ros/bounding_boxes", BoundingBoxes, self.objectInfoCB) ## Object information Subscriber
        # rospy.Subscriber("/darknet_ros/found_object", ObjectCount, self.objectCntCB)
    ...
    def objectInfoCB(self,data): ## Object information Subscriber
        ...
        self.objectCnt = len(object_boxes)
        object_type=[]
        object_pose_x=[]
        object_pose_y=[]
        object_velocity=[]
